...
class TestUsage:
    ...
    def test_usage_accepts_unfused_wait_component_fields(self):
        """Test Usage accepts split unfused wait attribution telemetry fields."""
        usage = Usage(
            prompt_tokens=1,
            completion_tokens=1,
            total_tokens=2,
            dflash_verify_eval_wait_unfused_target_posterior_steps=8,
            dflash_verify_eval_wait_unfused_target_posterior_mean_s=0.21,
            dflash_verify_eval_wait_unfused_draft_logits_steps=8,
            dflash_verify_eval_wait_unfused_draft_logits_mean_s=0.07,
            dflash_ddtree_tree_budget=4,
            dflash_ddtree_cycles_completed=12,
            dflash_ddtree_tokens_per_second=123.5,
        )

        assert usage.dflash_verify_eval_wait_unfused_target_posterior_steps == 8
        assert usage.dflash_verify_eval_wait_unfused_target_posterior_mean_s == 0.21
        assert usage.dflash_verify_eval_wait_unfused_draft_logits_steps == 8

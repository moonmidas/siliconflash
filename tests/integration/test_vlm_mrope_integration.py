...
MROPE_MODELS = [
    "/path/to/models/Qwen3-VL-30B-A3B-Instruct-3bit",
    "/path/to/models/Qwen3.5-27B-4bit",
    "/path/to/models/Qwen3.5-35B-A3B-4bit",
    "/path/to/models/GLM-4.6V-Flash-4bit",
    "/path/to/models/Qwen3.5-122B-A10B-oQ4",
    "/path/to/models/gemma-4-26b-a4b-it-4bit",
    "/path/to/models/gemma-3-12b-it-qat-4bit",
    "/path/to/models/gemma-4-e2b-it-4bit",
    "/path/to/models/Nemotron-Cascade-2-30B-A3B-4bit",
]

    ...
    function dashboard() {
        return {
            ...
            benchFormatMetric(value, digits = 1, suffix = '') {
            ...
            benchBuildText() {
                ...
                if (this.benchSingleResults.length > 0) {
                    ...
                    for (const r of this.benchSingleResults) {
                        const row = [
                            rpad(`pp${r.pp}/tg${r.tg}${r.benchmark_mode === 'nonstream_dflash' ? '·DFlash' : ''}`, 16),
                            pad(this.benchFormatMetric(r.ttft_ms, 1), 10),
                            pad(this.benchFormatMetric(r.tpot_ms, 2), 10),
                            pad(this.benchFormatMetric(r.processing_tps, 1, ' tok/s'), 12),
                            pad(this.benchFormatMetric(r.gen_tps, 1, ' tok/s'), 12),
                            pad(this.benchFormatMetric(r.e2e_latency_s, 3), 10),
                            pad(this.benchFormatMetric(r.total_throughput, 1, ' tok/s'), 12),

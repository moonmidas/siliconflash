...
class Scheduler:
    ...
    def _get_stop_tokens(self, ignore_eos: bool = False) -> Set[int]:
    ...
    def _create_batch_generator(self, sampling_params: SamplingParams) -> BatchGenerator:
        ...
        stop_tokens_set = self._get_stop_tokens(ignore_eos=sampling_params.ignore_eos)
    ...
    def _build_state_machine(self, request: "Request") -> SequenceStateMachine:
        ...
        """
        stop_tokens_set = self._get_stop_tokens(ignore_eos=request.sampling_params.ignore_eos)
    ...
    def _process_batch_responses(
        ...
        for response in responses:
            ...
            if parser_session is not None:
                ...
                # Non-streaming requests only need the final decoded text,
                # so skip per-token detokenization work on the hot path.
            ...
            output = None
            if request.stream_output or is_finished:

...
FAST_PROFILE_STREAM_MAX_TOKENS = 256
FAST_PROFILE_STREAM_THINKING_BUDGET = 128
...
def _apply_fast_profile_omitted_chat_bounds(
    *,
    model_id: str | None,
    request_stream: bool,
    request_max_tokens: int | None,
    merged_ct_kwargs: dict[str, Any] | None,
    max_tokens: int,
    thinking_budget: int | None,
) -> tuple[int, int | None]:
    """Apply narrow omitted-param bounds for the fast DFlash auto profile.

    This is intentionally scoped to streaming requests with omitted max_tokens so
    the benchmark lane and explicit client requests are unaffected.
    """
    if not request_stream or request_max_tokens is not None:
        return max_tokens, thinking_budget

    resolved = resolve_model_id(model_id)
    if not resolved or _server_state.settings_manager is None:
        return max_tokens, thinking_budget

    ms = _server_state.settings_manager.get_settings(resolved)
    if not getattr(ms, "dflash_auto_profile", False):
        return max_tokens, thinking_budget

    if ms.max_tokens is None:
        max_tokens = min(max_tokens, FAST_PROFILE_STREAM_MAX_TOKENS)

    enable_thinking = bool((merged_ct_kwargs or {}).get("enable_thinking"))
    if thinking_budget is None and enable_thinking and not ms.thinking_budget_enabled:
        thinking_budget = min(max_tokens, FAST_PROFILE_STREAM_THINKING_BUDGET)

    return max_tokens, thinking_budget


def _extract_dflash_usage_fields(output) -> dict:
    meta = getattr(output, "backend_metadata", None) or {}
    dflash = meta.get("dflash") if isinstance(meta, dict) else None
    if not isinstance(dflash, dict):
        return {}

    usage = {
        "dflash_requested": dflash.get("requested"),
        "dflash_used": dflash.get("used"),
        "dflash_reason": dflash.get("reason"),
        "dflash_backend": dflash.get("backend"),
    }

    telemetry = dflash.get("telemetry")
    if not isinstance(telemetry, dict):
        return usage

    telemetry_mapping = {
        "dflash_draft_steps": "draft_steps",
        "dflash_drafted_tokens": "drafted_tokens",
        "dflash_accepted_tokens": "accepted_tokens",
        "dflash_acceptance_rate": "acceptance_rate",
        "dflash_commit_events": "commit_events",
        "dflash_mean_commit_tokens": "mean_commit_tokens",
        "dflash_full_accept_steps": "full_accept_steps",
        "dflash_full_accept_rate": "full_accept_rate",
        "dflash_verify_passes": "verify_passes",
        "dflash_target_forward_passes": "target_forward_passes",
        "dflash_block_tokens_mean": "block_tokens_mean",
        "dflash_block_tokens_min": "block_tokens_min",
        "dflash_block_tokens_max": "block_tokens_max",
        "dflash_prefill_s": "prefill_s",
        "dflash_draft_s": "draft_s",
        "dflash_verify_s": "verify_s",
        "dflash_eval_s": "eval_s",
        "dflash_total_s": "total_s",
        "dflash_cache_restore_s": "cache_restore_s",
        "dflash_cache_rollback_calls": "cache_rollback_calls",
        "dflash_cache_trim_calls": "cache_trim_calls",
        "dflash_cache_trim_tokens": "cache_trim_tokens",
        "dflash_cache_full_accept_clears": "cache_full_accept_clears",
        "dflash_split_full_attention_calls": "split_full_attention_calls",
        "dflash_split_path_calls": "split_path_calls",
        "dflash_split_path_hit_rate": "split_path_hit_rate",
        "dflash_split_exact_prefix_calls": "split_exact_prefix_calls",
        "dflash_split_batched_2pass_calls": "split_batched_2pass_calls",
        "dflash_split_batched_2pass_fallback_calls": "split_batched_2pass_fallback_calls",
        "dflash_split_query_chunks": "split_query_chunks",
        "dflash_async_submit_calls": "async_submit_calls",
        "dflash_async_submit_to_consume_samples": "async_submit_to_consume_samples",
        "dflash_async_submit_to_consume_mean_s": "async_submit_to_consume_mean_s",
        "dflash_async_submit_to_consume_max_s": "async_submit_to_consume_max_s",
        "dflash_async_submit_to_consume_min_s": "async_submit_to_consume_min_s",
        "dflash_async_submit_unconsumed_steps": "async_submit_unconsumed_steps",
        "dflash_draft_submit_steps": "draft_submit_steps",
        "dflash_draft_submit_mean_s": "draft_submit_mean_s",
        "dflash_draft_submit_min_s": "draft_submit_min_s",
        "dflash_draft_submit_max_s": "draft_submit_max_s",
        "dflash_draft_sync_eval_wait_steps": "draft_sync_eval_wait_steps",
        "dflash_draft_sync_eval_wait_mean_s": "draft_sync_eval_wait_mean_s",
        "dflash_draft_sync_eval_wait_min_s": "draft_sync_eval_wait_min_s",
        "dflash_draft_sync_eval_wait_max_s": "draft_sync_eval_wait_max_s",
        "dflash_verify_submit_steps": "verify_submit_steps",
        "dflash_verify_submit_mean_s": "verify_submit_mean_s",
        "dflash_verify_submit_min_s": "verify_submit_min_s",
        "dflash_verify_submit_max_s": "verify_submit_max_s",
        "dflash_verify_host_gap_steps": "verify_host_gap_steps",
        "dflash_verify_host_gap_mean_s": "verify_host_gap_mean_s",
        "dflash_verify_host_gap_min_s": "verify_host_gap_min_s",
        "dflash_verify_host_gap_max_s": "verify_host_gap_max_s",
        "dflash_verify_eval_wait_steps": "verify_eval_wait_steps",
        "dflash_verify_eval_wait_mean_s": "verify_eval_wait_mean_s",
        "dflash_verify_eval_wait_min_s": "verify_eval_wait_min_s",
        "dflash_verify_eval_wait_max_s": "verify_eval_wait_max_s",
        "dflash_verify_eval_wait_fused_steps": "verify_eval_wait_fused_steps",
        "dflash_verify_eval_wait_fused_mean_s": "verify_eval_wait_fused_mean_s",
        "dflash_verify_eval_wait_fused_min_s": "verify_eval_wait_fused_min_s",
        "dflash_verify_eval_wait_fused_max_s": "verify_eval_wait_fused_max_s",
        "dflash_verify_eval_wait_unfused_steps": "verify_eval_wait_unfused_steps",
        "dflash_verify_eval_wait_unfused_mean_s": "verify_eval_wait_unfused_mean_s",
        "dflash_verify_eval_wait_unfused_min_s": "verify_eval_wait_unfused_min_s",
        "dflash_verify_eval_wait_unfused_max_s": "verify_eval_wait_unfused_max_s",
        "dflash_verify_eval_wait_unfused_target_posterior_steps": "verify_eval_wait_unfused_target_posterior_steps",
        "dflash_verify_eval_wait_unfused_target_posterior_mean_s": "verify_eval_wait_unfused_target_posterior_mean_s",
        "dflash_verify_eval_wait_unfused_target_posterior_min_s": "verify_eval_wait_unfused_target_posterior_min_s",
        "dflash_verify_eval_wait_unfused_target_posterior_max_s": "verify_eval_wait_unfused_target_posterior_max_s",
        "dflash_verify_eval_wait_unfused_draft_logits_steps": "verify_eval_wait_unfused_draft_logits_steps",
        "dflash_verify_eval_wait_unfused_draft_logits_mean_s": "verify_eval_wait_unfused_draft_logits_mean_s",
        "dflash_verify_eval_wait_unfused_draft_logits_min_s": "verify_eval_wait_unfused_draft_logits_min_s",
        "dflash_verify_eval_wait_unfused_draft_logits_max_s": "verify_eval_wait_unfused_draft_logits_max_s",
        "dflash_verify_eval_fused_steps": "verify_eval_fused_steps",
        "dflash_verify_eval_unfused_steps": "verify_eval_unfused_steps",
        "dflash_ddtree_enabled": "ddtree_enabled",
        "dflash_ddtree_native_runtime": "ddtree_native_runtime",
        "dflash_ddtree_tree_budget": "ddtree_tree_budget",
        "dflash_ddtree_cycles_completed": "ddtree_cycles_completed",
        "dflash_ddtree_ddtree_cycles_completed": "ddtree_ddtree_cycles_completed",
        "dflash_ddtree_dflash_cycles_completed": "ddtree_dflash_cycles_completed",
        "dflash_ddtree_dflash_accepted_from_draft": "ddtree_dflash_accepted_from_draft",
        "dflash_ddtree_avg_acceptance": "ddtree_avg_acceptance",
        "dflash_ddtree_tokens_per_second": "ddtree_tokens_per_second",
        "dflash_ddtree_fast_path_ratio": "ddtree_fast_path_ratio",
        "dflash_ddtree_fast_path_count": "ddtree_fast_path_count",
        "dflash_ddtree_slow_path_count": "ddtree_slow_path_count",
        "dflash_ddtree_tree_aware_commit_count": "ddtree_tree_aware_commit_count",
        "dflash_ddtree_tree_aware_linear": "ddtree_tree_aware_linear",
        "dflash_ddtree_exact_commit": "ddtree_exact_commit",
        "dflash_ddtree_dflash_controller_enabled": "ddtree_dflash_controller_enabled",
        "dflash_ddtree_dflash_controller_probe_count": "ddtree_dflash_controller_probe_count",
        "dflash_ddtree_dflash_controller_switch_count": "ddtree_dflash_controller_switch_count",
        "dflash_ddtree_elapsed_s": "ddtree_elapsed_s",
        "dflash_ddtree_prefill_s": "ddtree_prefill_s",
        "dflash_ddtree_tree_build_s": "ddtree_tree_build_s",
        "dflash_ddtree_tree_verify_s": "ddtree_tree_verify_s",
        "dflash_ddtree_tree_verify_linear_s": "ddtree_tree_verify_linear_s",
        "dflash_ddtree_tree_verify_attention_s": "ddtree_tree_verify_attention_s",
        "dflash_ddtree_commit_s": "ddtree_commit_s",
        "dflash_ddtree_dflash_draft_s": "ddtree_dflash_draft_s",
        "dflash_ddtree_dflash_verify_s": "ddtree_dflash_verify_s",
        "dflash_ddtree_dflash_replay_s": "ddtree_dflash_replay_s",
        "dflash_ddtree_dflash_commit_s": "ddtree_dflash_commit_s",
        "dflash_thermal_sidecar_enabled": "thermal_sidecar_enabled",
        "dflash_thermal_sidecar_sample_interval_s": "thermal_sidecar_sample_interval_s",
        "dflash_thermal_sidecar_sample_timeout_s": "thermal_sidecar_sample_timeout_s",
        "dflash_thermal_sidecar_samples": "thermal_sidecar_samples",
        "dflash_thermal_sidecar_failures": "thermal_sidecar_failures",
        "dflash_thermal_sidecar_last_sample_age_s": "thermal_sidecar_last_sample_age_s",
        "dflash_thermal_sidecar_thermal_warning_samples": "thermal_sidecar_thermal_warning_samples",
        "dflash_thermal_sidecar_performance_warning_samples": "thermal_sidecar_performance_warning_samples",
        "dflash_thermal_sidecar_cpu_power_status_samples": "thermal_sidecar_cpu_power_status_samples",
        "dflash_thermal_sidecar_thermal_warning_level_max": "thermal_sidecar_thermal_warning_level_max",
        "dflash_thermal_sidecar_performance_warning_level_max": "thermal_sidecar_performance_warning_level_max",
        "dflash_thermal_sidecar_cpu_power_status_max": "thermal_sidecar_cpu_power_status_max",
        "dflash_thermal_sidecar_cpu_speed_limit_samples": "thermal_sidecar_cpu_speed_limit_samples",
        "dflash_thermal_sidecar_cpu_speed_limit_mean_pct": "thermal_sidecar_cpu_speed_limit_mean_pct",
        "dflash_thermal_sidecar_cpu_speed_limit_min_pct": "thermal_sidecar_cpu_speed_limit_min_pct",
        "dflash_thermal_sidecar_cpu_speed_limit_max_pct": "thermal_sidecar_cpu_speed_limit_max_pct",
        "dflash_thermal_sidecar_gpu_speed_limit_samples": "thermal_sidecar_gpu_speed_limit_samples",
        "dflash_thermal_sidecar_gpu_speed_limit_mean_pct": "thermal_sidecar_gpu_speed_limit_mean_pct",
        "dflash_thermal_sidecar_gpu_speed_limit_min_pct": "thermal_sidecar_gpu_speed_limit_min_pct",
        "dflash_thermal_sidecar_gpu_speed_limit_max_pct": "thermal_sidecar_gpu_speed_limit_max_pct",
        "dflash_thermal_sidecar_cpu_scheduler_limit_samples": "thermal_sidecar_cpu_scheduler_limit_samples",
        "dflash_thermal_sidecar_cpu_scheduler_limit_mean_pct": "thermal_sidecar_cpu_scheduler_limit_mean_pct",
        "dflash_thermal_sidecar_cpu_scheduler_limit_min_pct": "thermal_sidecar_cpu_scheduler_limit_min_pct",
        "dflash_thermal_sidecar_cpu_scheduler_limit_max_pct": "thermal_sidecar_cpu_scheduler_limit_max_pct",
        "dflash_thermal_sidecar_cpu_available_samples": "thermal_sidecar_cpu_available_samples",
        "dflash_thermal_sidecar_cpu_available_mean": "thermal_sidecar_cpu_available_mean",
        "dflash_thermal_sidecar_cpu_available_min": "thermal_sidecar_cpu_available_min",
        "dflash_thermal_sidecar_cpu_available_max": "thermal_sidecar_cpu_available_max",
        "dflash_mx_active_mem_mean_bytes": "mx_active_mem_mean_bytes",
        "dflash_mx_active_mem_max_bytes": "mx_active_mem_max_bytes",
        "dflash_mx_cache_mem_mean_bytes": "mx_cache_mem_mean_bytes",
        "dflash_mx_cache_mem_max_bytes": "mx_cache_mem_max_bytes",
        "dflash_mx_peak_mem_max_bytes": "mx_peak_mem_max_bytes",
        "dflash_mx_recommended_working_set_bytes": "mx_recommended_working_set_bytes",
        "dflash_mx_peak_over_recommended_ratio": "mx_peak_over_recommended_ratio",
        "dflash_mx_peak_over_recommended_events": "mx_peak_over_recommended_events",
        "dflash_collapse_watchdog_enabled": "collapse_watchdog_enabled",
        "dflash_collapse_spike_events": "collapse_spike_events",
        "dflash_collapse_severe_spike_events": "collapse_severe_spike_events",
        "dflash_collapse_safe_mode_active": "collapse_safe_mode_active",
        "dflash_collapse_safe_mode_activations": "collapse_safe_mode_activations",
        "dflash_collapse_safe_mode_step": "collapse_safe_mode_step",
        "dflash_collapse_safe_mode_block_tokens": "collapse_safe_mode_block_tokens",
        "dflash_collapse_async_drain_calls": "collapse_async_drain_calls",
        "dflash_collapse_async_drain_s": "collapse_async_drain_s",
        "dflash_collapse_clear_cache_calls": "collapse_clear_cache_calls",
        "dflash_collapse_safe_sync_calls": "collapse_safe_sync_calls",
        "dflash_collapse_safe_sync_s": "collapse_safe_sync_s",
        "dflash_collapse_eval_step_mean_s": "collapse_eval_step_mean_s",
        "dflash_collapse_eval_step_max_s": "collapse_eval_step_max_s",
        "dflash_collapse_eval_step_min_s": "collapse_eval_step_min_s",
    }

    for usage_key, telemetry_key in telemetry_mapping.items():
    ...
    async def _build_completion():
        ...
        return CompletionResponse(
            ...
            usage=Usage(
                ...
                **_extract_dflash_usage_fields(last_output),
            ),
        ).model_dump_json()
...
async def create_chat_completion(
    ...
    max_tokens, thinking_budget = _apply_fast_profile_omitted_chat_bounds(
        model_id=request.model,
        request_stream=bool(request.stream),
        request_max_tokens=request.max_tokens,
        merged_ct_kwargs=merged_ct_kwargs or None,
        max_tokens=max_tokens,
    ...
    if getattr(request, "ignore_eos", None) is not None:
        chat_kwargs["ignore_eos"] = request.ignore_eos
    ...
    async def _build_chat_completion():
        ...
        return ChatCompletionResponse(
            ...
            usage=Usage(
                ...
                **_extract_dflash_usage_fields(output),
            ),
        ).model_dump_json()
